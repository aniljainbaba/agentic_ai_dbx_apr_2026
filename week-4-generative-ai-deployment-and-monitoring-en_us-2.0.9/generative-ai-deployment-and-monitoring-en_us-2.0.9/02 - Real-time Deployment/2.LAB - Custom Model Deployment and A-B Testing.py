...
# MAGIC
# MAGIC ## Set the registry URI to Unity Catalog
...
# MAGIC
# MAGIC ## Print the latest model version
...
# MAGIC
# MAGIC ## Define endpoint configuration
...
# MAGIC
# MAGIC ## If endpoint doesn't exist, create it
...
# MAGIC ## If endpoint does exist, update it to serve the new version
# MAGIC else:
...
# MAGIC
# MAGIC ## Display the endpoint URL
...
# MAGIC 2. Click on the **Configure AI Gateway** button
# MAGIC 3. Click on the **Enable inference tables** button
...
# MAGIC     - Under **My Models**, select the entity name that matches your model name: **`genai_shared_catalog.ws_<xxx>.rag_app`**. Model name is printed in the beginning of this notebook.
...
# MAGIC
# MAGIC 6. **Advanced Configuration**
...
# MAGIC
# MAGIC ## Define the question to be sent to the model for inference
# MAGIC messages = {"messages" : [
# MAGIC         {"role": "user", "content": "What is PPO?"}
# MAGIC     ]}
# MAGIC
# MAGIC ## Send the query to the specified serving endpoint and receive the response
# MAGIC answer = w.serving_endpoints.query(
# MAGIC   serving_endpoint_name, 
# MAGIC   inputs=messages
# MAGIC )
# MAGIC
# MAGIC ## Print the model's prediction from the response received
